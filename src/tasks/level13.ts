...
const Challenges: Task[] = [
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "init" },
    limit: { tries: 1 },
    freeaction: true,
  },
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "moxie" },
    limit: { tries: 1 },
    freeaction: true,
  },
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "muscle" },
    limit: { tries: 1 },
    freeaction: true,
  },
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "mysticality" },
    limit: { tries: 1 },
    freeaction: true,
  },
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "hot dmg, hot spell dmg" },
    limit: { tries: 1 },
    freeaction: true,
  },
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "cold dmg, cold spell dmg" },
    limit: { tries: 1 },
    freeaction: true,
  },
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "spooky dmg, spooky spell dmg" },
    limit: { tries: 1 },
    freeaction: true,
  },
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "stench dmg, stench spell dmg" },
    limit: { tries: 1 },
    freeaction: true,
  },
  {
    ...
    outfit: { familiar: $familiar`Disembodied Hand`, modifier: "sleaze dmg, sleaze spell dmg" },
    limit: { tries: 1 },
    freeaction: true,
  },
];
